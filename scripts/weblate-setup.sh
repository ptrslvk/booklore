...
#   2. Ensure your GitHub repo (ptrslvk/booklore) is public (required for Libre plan)
#
# Usage:
...
PROJECT_WEB="https://github.com/ptrslvk/booklore"

REPO_URL="https://github.com/ptrslvk/booklore.git"
REPO_BRANCH="develop"
